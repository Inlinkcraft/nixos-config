  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "SUPER,D,exec,eww open-many --toggle calendar profile media quicksettings stats clock power restart logout lock --arg width=1920 --arg height=1080 --arg spacing=2"
